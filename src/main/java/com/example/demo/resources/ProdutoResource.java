...
@RestController
@RequestMapping(value="/produtos") // mapeando um end point
public class ProdutoResource {
	
	

	@Autowired // instancia automaticamente
	private ProdutoService service;  //Controlador Rest está acessando o Serviço
	
	@RequestMapping(value="/{id}", method=RequestMethod.GET) 		// add um and point p/ o metodo ResponseEntity
	public ResponseEntity<Produto> find(@PathVariable Integer id) {		// id vem da URL 
